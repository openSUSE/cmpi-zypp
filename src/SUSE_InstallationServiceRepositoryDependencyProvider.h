#ifndef SUSE_INSTALLATIONSERVICEREPOSITORYDEPENDENCYPROVIDERCLASS_H
#define SUSE_INSTALLATIONSERVICEREPOSITORYDEPENDENCYPROVIDERCLASS_H
...
namespace cmpizypp
{
  /**
  */
  class SUSE_InstallationServiceRepositoryDependencyProviderClass : public CmpiInstanceMI, public CmpiAssociationMI
  {
    public:
      SUSE_InstallationServiceRepositoryDependencyProviderClass( const CmpiBroker & mbp, const CmpiContext & ctx );
...
#endif // SUSE_INSTALLATIONSERVICEREPOSITORYDEPENDENCYPROVIDERCLASS_H
