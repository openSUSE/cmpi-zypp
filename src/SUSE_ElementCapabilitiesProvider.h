#ifndef SUSE_ELEMENTCAPABILITIESPROVIDERCLASS_H
#define SUSE_ELEMENTCAPABILITIESPROVIDERCLASS_H
...
namespace cmpizypp
{
  /**
  */
  class SUSE_ElementCapabilitiesProviderClass : public CmpiInstanceMI, public CmpiAssociationMI
  {
    public:
      SUSE_ElementCapabilitiesProviderClass( const CmpiBroker & mbp, const CmpiContext & ctx );
...
#endif // SUSE_ELEMENTCAPABILITIESPROVIDERCLASS_H
